...
#if   (defined ( __CC_ARM ))
mem_TypeDef memory_pool __attribute__((at(0x68080000)));
#elif (defined (__ICCARM__))
#pragma location = 0x68080000
__no_init mem_TypeDef memory_pool;
#elif defined   (  __GNUC__  )
mem_TypeDef memory_pool __attribute__((section(".ExtRAMData")));
#elif defined ( __TASKING__ )
mem_TypeDef memory_pool __at(0x68080000);  
#endif
...
//   memory_pool.mallocBase = 0x64080000 + sizeof(mem_TypeDef);
	memory_pool.mallocBase = 0x68080000 + sizeof(mem_TypeDef);
}
